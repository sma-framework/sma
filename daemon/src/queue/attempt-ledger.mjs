 ...
 * единицы. Замерено 31.08.2026: вторая физическая попытка SB-176 записана в реестр ТЕМ ЖЕ номером
 * 1, что и первая. Цена не в красоте числа: каталогом прогона служит `<taskId>#<attempt>` (см.
