...
export const EVENT_NAMES = [
  ...
  'chat.stage',
  // Мест больше нет: демону некуда взять следующую задачу, пока не освободится место. Единственный
  // отказ, который в остальных списках не виден вообще ничем — очередь стоит, работники не
  // шевелятся, ни одна строка не меняет состояния, — и потому у него свой звонок.
  'seats.full',
] as const
