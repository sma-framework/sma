...
/* Вид, выбранный владельцем 01.09.2026: параметры примера, ЦВЕТА — фирменная лестница ожидания, руки выключены. */
const RING_PARAMS = Object.freeze({
  color: [0x74 / 255, 0xdb / 255, 0xa0 / 255] as const, // #74dba0 — изумруд лестницы ожидания
  colorTwo: [0x3b / 255, 0x82 / 255, 0xf6 / 255] as const, // #3b82f6 — фирменный синий
  speed: 1,
  ringCount: 6,
  attenuation: 10,
  lineThickness: 2,
