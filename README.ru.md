...
Под капотом работает координационно-подотчётный CLI (`pnpm sma`) — 89 команд, у каждой есть встроенный объяснитель (`pnpm sma explain <команда>`). Полный справочник живёт в [scripts/sma/README.md](scripts/sma/README.md).
