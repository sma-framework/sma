...
<p align="center">
  <img src="https://img.shields.io/badge/version-5.0.4-3B82F6" alt="версия 5.0.4">
  <img src="https://img.shields.io/badge/tests-1880%2F1880-3CC0A0" alt="тесты 1880/1880">
...
Закрепление сильнее профиля — но только для этого агента: остальные остаются на своих местах, и автоматическое повышение тира его не сдвигает. Имя, которого SMA не знает, просто игнорируется: опечатка ничего не меняет и не роняет запуск. Полный порядок разрешения и таблица тиров по рантаймам — в [scripts/sma/README.md](scripts/sma/README.md).
