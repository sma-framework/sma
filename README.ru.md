...
> Где SMA сейчас и что дальше: **оркестрация V5 (парк работников 24/7) — вышла → V5.1 работает с тем, что у вас есть + модель памяти 1.0 + рабочий фронт → V5.2 измеренная память → V5.3 управление + укреплённый парк.**
...
- **[ROADMAP.ru.md](ROADMAP.ru.md)** — куда SMA идёт дальше: оркестрация V5 (вышла), затем V5.1 → V5.3 — дверь импорта, рабочий фронт, федерация машин и программа фундамента памяти. English: [ROADMAP.md](ROADMAP.md).
