...
Под капотом работает координационно-подотчётный CLI (`pnpm sma`) — 88 команд, у каждой есть встроенный объяснитель (`pnpm sma explain <команда>`). Полный справочник живёт в [scripts/sma/README.md](scripts/sma/README.md).
