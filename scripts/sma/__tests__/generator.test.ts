...
- messaging — channels. · aliases: whatsapp, telegram
...
beforeEach(() => {
  ...
  note(corpusDir, 'bbb.md', {
    description: 'WhatsApp is the primary customer channel not Telegram',
    kind: 'reference',
    tags: ['messaging'],
  ...
  note(corpusDir, 'ddd.md', {
    description: 'Zadarma telephony is abandoned do not re-propose it',
    kind: 'decision',
    tags: ['messaging'],
  ...
  note(corpusDir, 'eee.md', {
    description: 'VK is the fallback messaging channel for RU customers',
    kind: 'reference',
    tags: ['messaging'],
