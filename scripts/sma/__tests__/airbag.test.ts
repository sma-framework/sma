...
// ── 2026-07-10: the --schema-check contract — receipts pin STRUCTURE, never accruing refs ──

describe('snapshotListSchemaOk — deterministic airbag-list shape check (Test 10)', () => {
