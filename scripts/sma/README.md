...
| `eval` | The gold-set benchmark of the memory layer: what retrieval gets right, priced by the canon's own metrics, with floors that make the exit code a verdict |
