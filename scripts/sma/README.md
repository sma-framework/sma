...
- **Reflex guard (9.1-10)** — the lesson note `feedback_memory_write_via_fs_not_write_tool.md`
...
| `MEM-SECRET` | critical | screens note bodies for secret material at the corpus door (9.1-14) |
