...
/**
 * NEGATION_STOPLIST (precision mechanism 2, forensics rows 2/7/8) — sentence-context
 ...
 * asserted claim (precision mechanism 2, proximity guard). A path token far from every
...
/**
 * dedupeByTranscriptSha(events) -> events with duplicate receipts collapsed (precision
