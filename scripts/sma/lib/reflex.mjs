/**
 * reflex.mjs — the P2 reflex consumer core (B1/B2).
 *
 ...
 *
 * POSTURE (carried-forward lock): advisory WARN only —
 * permissionDecision is ALWAYS 'allow'; hard deny stays security-guard-only.
 * Soft-deny is the GATES tier, never a reflex.
 *
...
/**
 * formatWarn(note, tier) → the WARN text (rule line + How-to-apply
