...
/** Event kinds the journal records (RESEARCH Pattern 5; `blocked` is reused by the stall window). */
...
export function append(entry, opts = {}) {
  ...
  const record = {
    ...
    // Carry any extra payload (e.g. a blocked event's `reason` — the park protocol).
    ...Object.fromEntries(
