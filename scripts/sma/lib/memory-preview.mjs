/**
 * memory-preview.mjs — the onboarding memory-graph preview (v3.6).
 *
 ...
 * the same HEAD renders byte-identically (that determinism is the
 ...
 *
 * Consume-never-reimplement: history mining IS excavate.mineRepo;
