...
/**
 * The canonical stamp field for a SEPARATE-CONTEXT JUDGE's model id.
 ...
 * (2026-07-10): a structural receipt over the model-version guard's
 ...
 * every reverify by construction (the R1 lesson). Valid: an object
 ...
 * `judgeModelId` (JUDGE_MODEL_FIELD) without mutating any other field.
