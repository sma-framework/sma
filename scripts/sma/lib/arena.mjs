/**
 * arena.mjs — the comparative benchmark arena scorer.
 *
 * ═══════════════════════════ WHAT THIS IS ════════════════════════════════════
 *
 ...
 * ═══════════════════════════ THE THREE LOCKS ═════════════════════════════════
 *
 * the tested claim is cost-per-RESULT, not cost-per-task. The headline is
 ...
 *
 * consume, never reimplement. The spend-adapter is the SOLE
 ...
 * column, NEVER the sort key — so an arm that is expensive per task can
 ...
 * The timestamp is the only field that legitimately varies over time.
 */
 ...
 * Plain language, formal Вы, NO em-dashes in the RU copy.
 */
