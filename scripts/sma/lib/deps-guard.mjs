 ...
 *
 * ГОДИТСЯ ЛИ ДЕРЕВО, ЧТОБЫ ЗАПУСКАТЬ В НЁМ ТЕСТЫ. Вопрос задаётся ровно теми тремя
 ...
 *   3. среди записей каталога есть ВИСЯЧАЯ ссылка — след разорванного склада pnpm,
