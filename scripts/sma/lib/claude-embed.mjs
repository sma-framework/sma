/**
 * claude-embed.mjs — the installer's CLAUDE.md rules block (v3.6).
 *
 ...
 *
 * Consume-never-reimplement: the splice engine is emit.mjs's
 ...
 * as the last line (the falsifiable check — safe-command allowlisted).
 */
...
/**
 * embedSelftest({tmpRoot}) — the fixture round-trip on a real temp dir:
