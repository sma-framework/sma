/**
 * state-section.mjs — the machine-managed STATE.md section.
 *
 * STATE.md was rewritten under executors repeatedly during P9 (the B6 conflict
 * class). the answer is a FENCED region wrapping the three contended
...
function mutate(transform, opts = {}) {
  ...
  // re-read-before-write guard: a change since raw1 → abort, do not write.
  let raw2
  try {
