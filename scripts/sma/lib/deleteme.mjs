/**
 * deleteme.mjs — the one-click OFF-RAMP (v3.6). Reverses every artifact the
...
// block (claude-embed.mjs). Tokens are a cross-module CONTRACT: deleteme
 ...
 * (wrapped-command.json): hadNone -> delete the key; a stored original ->
