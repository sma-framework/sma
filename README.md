...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-5916%2F5916-3CC0A0" alt="tests 5916/5916">
<!-- sma:passport:begin -->
...
- **Waiting stopped being a white screen.** Switching a project — and every read that has no answer yet — shows ONE waiting language where the content will be: a layered horizon band in the theme's own colours, standing exactly where the answer is about to appear. After a couple of seconds WORDS join the motion: what is opening and how long it has been going. Motion promises, words tell the truth, and a handsome animation stops hiding a hang. The system's «reduce motion» preference is honoured — the layers stand still and the horizon stays — and no transition runs longer than a third of a second.
