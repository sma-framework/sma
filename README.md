...
<p align="center">
  <img src="https://img.shields.io/badge/version-5.7.0-3B82F6" alt="version 5.7.0">
  <img src="https://img.shields.io/badge/tests-5509%2F5509-3CC0A0" alt="tests 5509/5509">
<!-- sma:passport:begin -->
...
**🚦 Coordination without a server.** Sessions register themselves, scopes are claimed, a collision warns *before* the keystroke — and anything two terminals could race on (a migration number, a release version) comes from one shared counter. All of it plain files in your repository.
