...
Once 49.4-01 lands (`sma vendor` ledger + `docs/VENDOR-LEDGER.md`), this weekly check should become a **ledger row** (`source: github.com/open-gsd/gsd-core`, cadence: weekly, pin: 1.6.1) so the ship gate carries it and the cadence cannot be silently dropped. Until then: next manual check **2026-07-20**, report to this directory.
