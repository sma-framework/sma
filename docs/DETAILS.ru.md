...
называется рекламой: работающий демон **не** проводит свои смены статусов через машину состояний, а
боевые строки попыток не несут полей штампа. Этот слой — проверенная формальная опора, к которой
приложен код, а не исполнитель, встроенный в цикл. §5 документа
[FLEET-INVARIANTS.md](FLEET-INVARIANTS.md) говорит, что именно намеренно не является целью и как
обстоит дело с подключением.
