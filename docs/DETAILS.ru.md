...
| `worktree` · `merge` | Изоляция воркдеревьев на терминал и сериализованные локальные ворота слияния (сам пуш остаётся ритуалом по команде человека) |
