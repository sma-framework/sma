...
node scripts/sma/cli.mjs explain <verb>  # what any of the 89 verbs is for
```
...
`sma-framework@5.1.0` (audited 2026-08-02) — **1106 files, 4.4 MB packed /
16.7 MB unpacked**. Reproduce it yourself in a clone with:
