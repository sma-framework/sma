...
// sma-cursor-session-start.js — Cursor sessionStart hook (issue #777)
//
...
//   - If absent, nudges the user toward /sma:new-project.
...
const MSG_PRESENT =
  'SMA: .planning/STATE.md is present — review the current phase and any blockers before acting.';
const MSG_ABSENT =
...
process.stdin.on('end', () => {
  ...
  try {
    ...
    // Fail open — never block a Cursor session because of a SMA hook error.
