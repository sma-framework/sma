...
// sma-cursor-subagent-start.js — Cursor subagentStart hook (ADR-1239 / #2089)
//
...
//
// Behaviour:
//   - Injects a brief SMA state reminder so subagents (planner, executor,
...
const MSG_PRESENT =
  'SMA: Subagent session started — review .planning/STATE.md for the current phase and any blockers before acting.';
const MSG_ABSENT =
  'SMA: Subagent session started — no .planning/ workflow found.';
