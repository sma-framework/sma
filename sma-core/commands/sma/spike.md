...
Spikes live in `.planning/spikes/` and integrate with SMA commit patterns, state tracking,
...
<execution_context>
@~/.claude/sma-core/workflows/spike.md
@~/.claude/sma-core/workflows/spike-wrap-up.md
