...
<execution_context>
@~/.claude/sma-core/workflows/spec-phase.md
@~/.claude/sma-core/templates/spec.md
</execution_context>
...
- User knows they can now run /sma:discuss-phase which will load SPEC.md automatically
</success_criteria>
