...
integrate with SMA commit patterns, state tracking, and handoff workflows. Loads spike
...
<execution_context>
@~/.claude/sma-core/workflows/sketch.md
@~/.claude/sma-core/workflows/sketch-wrap-up.md
