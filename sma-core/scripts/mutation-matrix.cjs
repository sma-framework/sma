 ...
 *     "matrix": {
 *       "include": [
 *         { "name": "<module>", "mutate": "sma-core/bin/lib/<module>.cjs", "tests": "<space-joined test files>" },
 *         ...
 *       ]
 *     }
 *   }
...
const COVERED = {
  'context-utilization': {
    cjs: 'sma-core/bin/lib/context-utilization.cjs',
    tests: [
  ...
  'prompt-budget': {
    cjs: 'sma-core/bin/lib/prompt-budget.cjs',
    tests: [
  ...
  frontmatter: {
    cjs: 'sma-core/bin/lib/frontmatter.cjs',
    tests: [
  ...
  'adr-parser': {
    cjs: 'sma-core/bin/lib/adr-parser.cjs',
    tests: [
  ...
  'config-schema': {
    cjs: 'sma-core/bin/lib/config-schema.cjs',
    tests: [
  ...
  'active-workstream-store': {
    cjs: 'sma-core/bin/lib/active-workstream-store.cjs',
    tests: [
  ...
  'core-utils': {
    cjs: 'sma-core/bin/lib/core-utils.cjs',
    tests: [
