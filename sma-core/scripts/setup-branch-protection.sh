...
#
# Apply branch protection rules to `main` and `next` for the SMA repo.
...
#
# Requirements:
#   - gh CLI authenticated against sma-framework/sma with admin scope
#   - jq installed
#
# What it sets:
#
