...
<!-- For checkpoint task examples and patterns, see @~/.claude/sma-core/references/checkpoints.md -->
...
See `~/.claude/sma-core/references/tdd.md` for TDD plan structure.
...
See `~/.claude/sma-core/templates/user-setup.md` for full schema and examples
...
See `~/.claude/sma-core/workflows/verify-phase.md` for verification logic.
