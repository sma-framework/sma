...
Visual patterns for user-facing SMA output. Orchestrators @-reference this file.
...
**Also available:**
- `/sma-alternative-1` — description
- `/sma-alternative-2` — description
...
- Skipping `SMA ►` prefix in banners
- Random emoji (`🚀`, `✨`, `💫`)
