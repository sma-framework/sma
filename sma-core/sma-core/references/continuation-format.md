...
- `/sma:discuss-phase 2 --assumptions` — check assumptions
...
**Also available:**
- `/sma:discuss-phase 2` — gather context first
- `/sma:plan-phase --research-phase 2` — investigate unknowns
- Review roadmap
...
**Also available:**
- `/sma:discuss-phase 3` — gather context first
- `/sma:plan-phase --research-phase 3` — investigate unknowns
...
**To plan directly:** `/sma:plan-phase 3`

**To discuss context first:** `/sma:discuss-phase 3`

**To research unknowns:** `/sma:plan-phase --research-phase 3`
