...
Run the verifier as a child process (the sma-tools binary directory is not required — the script ships under `sma-core/bin/` in the source repo and is installed to `${SMA_HOME}/sma-core/bin/`):
