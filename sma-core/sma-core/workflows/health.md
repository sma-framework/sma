...
sma_run query validate.context \
...
```bash
sma_run query validate.health $REPAIR_FLAG $BACKFILL_FLAG
```
...
- [E001] config.json: JSON parse error at line 5
  Fix: Run /sma:health --repair to reset to defaults

- [E002] PROJECT.md not found
  Fix: Run /sma:new-project to create
```
...
```
---
N issues can be auto-repaired. Run: /sma:health --repair
```
</step>
...
```
Would you like to run /sma:health --repair to fix N issues automatically?
```
...
| W019 | warning | Unrecognized .planning/ root file — not a canonical SMA artifact | No |
