...
<trigger>
This workflow executes when `--power` flag is present in ARGUMENTS to `/sma:discuss-phase`.
...
Consider running /sma:discuss-phase {N} again to refine before planning.
```
