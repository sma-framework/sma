<purpose>
Remove a SMA workspace, cleaning up git worktrees and deleting the workspace directory.
</purpose>
...
INIT=$(sma_run query init.remove-workspace "$WORKSPACE_NAME")
...
First run `/sma:workspace --list` to show available workspaces, then ask:
