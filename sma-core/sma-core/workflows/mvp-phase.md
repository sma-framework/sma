...
<required_reading>
@~/.claude/sma-core/references/user-story-template.md
@~/.claude/sma-core/references/spidr-splitting.md
@~/.claude/sma-core/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@~/.claude/sma-core/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `AskUserQuestion` calls. Each is free-text. After all three, assemble into the canonical sentence per `@~/.claude/sma-core/references/user-story-template.md`:
...
Run the SPIDR rules from `@~/.claude/sma-core/references/spidr-splitting.md`. Briefly:
