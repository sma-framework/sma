...
const capabilities = {
  ...
  "pi": {
    ...
    "version": "1.7.0",
    "title": "pi",
    "description": "pi (pi.dev) — bun-runtime programmatic-CLI; TS ExtensionAPI (registerCommand/registerTool/registerProvider/pi.on); single native-extension file at ~/.pi/agent/extensions/sma.cjs; no shared-settings hook surface; tier-2 support.",
    "tier": "core",
    "requires": [],
    "engines": {
      "sma": ">=1.7.0"
