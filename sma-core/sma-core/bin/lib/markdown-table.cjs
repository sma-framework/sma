 ...
 * no I/O. Compiled by tsc to sma-core/bin/lib/markdown-table.cjs.
 *
...
// ─── Schema registry ──────────────────────────────────────────────────────────
/**
 * Canonical column-header shapes for every GFM table SMA parses or generates.
 ...
 *
 * Scope note: SMA planning tables (STATE.md/ROADMAP.md/requirements.md/
 ...
 * guard). Never touches disk, git, or the clock — callers (the `sma-tools
...
// Consumers: require('../sma-core/bin/lib/markdown-table.cjs')
