 ...
 *
 * SMA registers for the 6 events in the portable floor + subagent lifecycle
 * (AC4a upgrade, #2089):
 *   sessionStart, postToolUse, preToolUse, stop, subagentStart, subagentStop
 */
'use strict';
Object.defineProperty(exports, "__esModule", { value: true });
exports.SMA_HOOK_MARKER = exports.CURSOR_EVENT_SCRIPT_MAP = exports.CURSOR_HOOK_EVENTS = void 0;
...
/**
 * The full set of Cursor hook events SMA can register for.
 ...
 *
 * Convention: `sma-cursor-<kebab-event>.js`. The script files are authored in
...
exports.CURSOR_EVENT_SCRIPT_MAP = Object.freeze({
    sessionStart: 'sma-cursor-session-start.js',
    postToolUse: 'sma-cursor-post-tool.js',
    preToolUse: 'sma-cursor-pre-tool.js',
    stop: 'sma-cursor-stop.js',
    subagentStart: 'sma-cursor-subagent-start.js',
    subagentStop: 'sma-cursor-subagent-stop.js',
});
/**
 * The SMA-managed marker written into each hooks.json entry so the
 * reconcile pass can distinguish SMA-owned entries from user-owned ones.
 */
exports.SMA_HOOK_MARKER = 'sma-managed';
/**
 ...
 * @returns array of script filenames (e.g. `['sma-cursor-session-start.js', ...]`)
 */
 ...
 * Each entry is `{ type: 'command', command: <cmd>, [SMA_HOOK_MARKER]: true }`.
 *
