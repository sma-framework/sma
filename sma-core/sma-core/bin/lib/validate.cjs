 ...
 *   - Issue #6 (sma-framework/sma)
 *   - Issue #26 (sma-framework/sma)
...
// deep dirs (02-04-01-deep), and project-code-prefixed variants (SMA-02-01-setup).
...
// multi-segment tokens like "02-01" from "02-01-setup" or "SMA-02-01-setup".
...
function buildRoadmapPhaseVariants(roadmapContent) {
    ...
    // and bracket-prefixed (### [SMA] Phase 2-01:) headings.
