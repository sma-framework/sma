...
exports.FIELD_CLASSIFICATION = Object.freeze(Object.assign(Object.create(null), {
    // Schema
    sma_state_version: { source: 'free', preservation: 'derive' },
 ...
 * canonical template at `sma-core/templates/state.md`. Sub-headings (H3) like
 ...
 *
 * Verified against `sma-core/templates/state.md` (codex Phase 1 review).
 */
 ...
 * "defining requirements" starting state. `sma_state_version` is preserved.
...
function milestoneSwitchCore(content, intent, deps) {
    ...
    // boundary). sma_state_version is preserved.
    const fm = {
...
function reconcileByPhaseTable(content, deps, timestamp, log) {
    ...
    if (!inventory || inventory.length === 0)
        return content;
    // The canonical table shape (from sma-core/templates/state.md):
 ...
 * `sma-core/templates/state.md`). Rebuild clears any `**Field:** [placeholder]`
