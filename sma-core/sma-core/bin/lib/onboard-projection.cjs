...
function buildHandoffCommands(cwd) {
    ...
    return {
        ingest_docs: (0, runtime_slash_cjs_1.formatSmaSlash)('ingest-docs', runtime),
        manager: (0, runtime_slash_cjs_1.formatSmaSlash)('manager', runtime),
        map_codebase: (0, runtime_slash_cjs_1.formatSmaSlash)('map-codebase', runtime),
        map_codebase_fast: (0, runtime_slash_cjs_1.formatSmaSlash)('map-codebase --fast', runtime),
        new_project: (0, runtime_slash_cjs_1.formatSmaSlash)('new-project', runtime),
        onboard: (0, runtime_slash_cjs_1.formatSmaSlash)('onboard', runtime),
    };
}
