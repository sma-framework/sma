"use strict";
/**
 * Installer migration: remove legacy Codex hooks.json SMA hook registrations.
 *
...
const migration = {
    ...
    title: 'Remove legacy Codex hooks.json SMA hook registrations',
    description: 'Remove legacy Codex hooks.json SMA hook registrations after config.toml migration.',
    introducedIn: '1.50.0',
    runtimes: ['codex'],
    scopes: ['global', 'local'],
    destructive: true,
        ...
        return [
            {
                ...
                value: pruned.value,
                deleteIfEmpty: true,
                reason: 'legacy Codex hooks.json SMA registration retired by installer migration',
                ownershipEvidence: 'pruned command matches generated SMA hook command under the install hooks directory',
            },
        ];
    },
};
