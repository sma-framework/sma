...
function cmdMilestoneComplete(cwd, version, options, raw) {
    ...
    // resolves to the workstream base when SMA_WORKSTREAM is set and to root .planning otherwise
    ...
    if (node_fs_1.default.existsSync(statePath)) {
        const result = (0, state_transition_cjs_1.transitionCore)(node_fs_1.default.readFileSync(statePath, 'utf-8'), {
            ...
            version,
            nextMilestoneCommand: (0, runtime_slash_cjs_1.formatSmaSlash)('new-milestone', (0, runtime_slash_cjs_1.resolveRuntime)(cwd)),
