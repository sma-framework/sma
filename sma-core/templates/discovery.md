...
For deep ecosystem research ("how do experts build this"), use `/sma-plan-phase --research-phase` which produces RESEARCH.md.
...
- Use `/sma-plan-phase --research-phase` for these
</guidelines>
