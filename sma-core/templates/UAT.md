...
- This section feeds directly into /sma-plan-phase --gaps
...
5. status → "diagnosed"
6. Ready for /sma-plan-phase --gaps with root causes
...
**Creation:** When /sma-verify-work starts new session
...
- `/sma-verify-work {phase}` picks up from first pending/blocked test
