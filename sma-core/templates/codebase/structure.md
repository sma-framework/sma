...
│   └── sma/           # SMA-specific commands
├── sma-core/     # Skill resources
...
**New Slash Command:**
- Primary code: `commands/sma/{command-name}.md`
- Tests: `tests/commands/{command-name}.test.js` (if testing implemented)
- Documentation: Update `README.md` with new command

**New Template:**
- Implementation: `sma-core/templates/{name}.md`
- Documentation: Template is self-documenting (includes guidelines)

**New Workflow:**
- Implementation: `sma-core/workflows/{name}.md`
- Usage: Reference from command with `@$HOME/.claude/sma-core/workflows/{name}.md`

**New Reference Document:**
- Implementation: `sma-core/references/{name}.md`
