...
Spawned by the `/sma-docs-update` workflow. Each spawn receives a `<verify_assignment>` XML block containing:
...
- **SMA marker**: The comment `<!-- generated-by: sma-doc-writer -->` — skip entirely.
