 ...
 *   1. If commandsSmaDir exists, load from source (repo-checkout behavior).
 *   2. Otherwise, fall back to installed skills at configDir/skills/sma-[stem]/SKILL.md.
 *
 * In an installed runtime the commands/sma source tree is absent; only the
