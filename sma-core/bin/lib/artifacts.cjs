"use strict";
/**
 * Canonical SMA artifact registry (ADR-457 build-at-publish: the hand-written
 ...
 * are added.
 *
 * Enumerates the file names that sma workflows officially produce at the
 * .planning/ root level. Used by sma-health (W019) to flag unrecognized files
...
exports.CANONICAL_PATTERNS = [
    /^v\d+\.\d+(?:\.\d+)?-MILESTONE-AUDIT\.md$/i, // sma-complete-milestone (pre-archive)
