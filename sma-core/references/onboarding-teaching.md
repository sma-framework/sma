# Onboarding teaching modules — the five things a new user must understand

Delivered staged, one module per stage, never as one lecture.
...
before the stage it makes meaningful, never one front-loaded lecture).
