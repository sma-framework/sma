...
| PHI-defer / PHI handling | "Is this field/route PHI?" is semantic; the security-regression-guard owns its concrete sub-checks (never-log-PHI, encryption-at-rest, Bedrock fail-closed) | security-regression-guard skill |
