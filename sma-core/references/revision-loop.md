...
|----------|---------------|---------------|-------|
| plan-phase | sma-planner | sma-plan-checker | Revision prompt via planner-revision.md |
| execute-phase | sma-executor | sma-verifier | Post-execution verification |
| discuss-phase | orchestrator | sma-plan-checker | Inline revision by orchestrator |
