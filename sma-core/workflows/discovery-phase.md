...
See $HOME/.claude/sma-core/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using $HOME/.claude/sma-core/templates/discovery.md structure:
...
1. **Scope the discovery** using $HOME/.claude/sma-core/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from $HOME/.claude/sma-core/templates/discovery.md
...
Use $HOME/.claude/sma-core/templates/discovery.md.
