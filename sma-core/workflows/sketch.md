...
Companion to `/sma-sketch --wrap-up`.
...
@$HOME/.claude/sma-core/references/sketch-theme-system.md
@$HOME/.claude/sma-core/references/sketch-variant-patterns.md
@$HOME/.claude/sma-core/references/sketch-interactivity.md
@$HOME/.claude/sma-core/references/sketch-tooling.md
</required_reading>
...
```bash
sma_run query commit "docs(sketch-NNN): [winning direction] — [key visual insight]" --files .planning/sketches/NNN-descriptive-name/ .planning/sketches/MANIFEST.md
```
...
**Also available:**
- `/sma-sketch` — sketch more (or run with no argument for frontier mode)
- `/sma-plan-phase` — start building the real UI
- `/sma-spike` — spike technical feasibility of a design pattern
