...
|--------------------------|----------|-----|
| Starting a new project, "set up", "initialize" | `/sma-new-project` | Needs full project initialization |
| Mapping or analyzing an existing codebase | `/sma-map-codebase` | Codebase discovery |
...
**Requires `.planning/` directory:** All routes except `/sma-new-project`, `/sma-map-codebase`, `/sma-spike`, `/sma-sketch`, and `/sma-help`. If the project doesn't exist and the route requires it, suggest `/sma-new-project` first.
