...
<required_reading>
@$HOME/.claude/sma-core/references/ai-frameworks.md
@$HOME/.claude/sma-core/references/ai-evals.md
</required_reading>
...
```markdown
Read $HOME/.claude/agents/sma-framework-selector.md for instructions.
...
```markdown
Read $HOME/.claude/agents/sma-ai-researcher.md for instructions.
...
```markdown
Read $HOME/.claude/agents/sma-domain-researcher.md for instructions.
...
```markdown
Read $HOME/.claude/agents/sma-eval-planner.md for instructions.
