...
If "Skip": Phase directories remain in `.planning/phases/` as raw execution history. Use `/sma-cleanup` later to archive retroactively.
...
**If doesn't exist:** Create from template at `$HOME/.claude/sma-core/templates/retrospective.md`.
