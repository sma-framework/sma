...
```markdown
Read $HOME/.claude/agents/sma-ui-researcher.md for instructions.
...
Template: $HOME/.claude/sma-core/templates/UI-SPEC.md
</output>
...
```markdown
Read $HOME/.claude/agents/sma-ui-checker.md for instructions.
