...
<template>
@$HOME/.claude/sma-core/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@$HOME/.claude/sma-core/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `$HOME/.claude/sma-core/workflows/transition.md`.
...
- Follow @$HOME/.claude/sma-core/workflows/diagnose-issues.md
