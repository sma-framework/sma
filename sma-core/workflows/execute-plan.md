...
49-14 executor died overnight mid-task-3 and recovery cost a hand-built
...
(this is the P49 `state.advance-plan` error class — the handler used to choke on the
