---
name: sma-forensics
description: "Post-mortem investigation for failed SMA workflows — diagnoses what went wrong."
...
<objective>
Investigate what went wrong during a SMA workflow execution. Analyzes git history, `.planning/` artifacts, and file system state to detect anomalies and generate a structured diagnostic report.
...
<execution_context>
@~/.claude/sma-core/workflows/forensics.md
</execution_context>
