...
<objective>
Capture ideas, tasks, notes, and seeds to their appropriate destination in the SMA system.
...
<execution_context>
@~/.claude/sma-core/workflows/add-todo.md
@~/.claude/sma-core/workflows/note.md
@~/.claude/sma-core/workflows/add-backlog.md
@~/.claude/sma-core/workflows/plant-seed.md
@~/.claude/sma-core/workflows/check-todos.md
@~/.claude/sma-core/workflows/list-seeds.md
