...
<objective>
Analyze existing codebase using parallel sma-codebase-mapper agents to produce structured codebase documents.
...
<execution_context>
@~/.claude/sma-core/workflows/map-codebase.md
</execution_context>
...
- Via /sma-onboard for first-time brownfield setup - creates codebase map first
- After /sma-new-project (greenfield codebases) - updates codebase map as code evolves
...
3. Spawn 4 parallel sma-codebase-mapper agents:
...
7. Offer next steps (typically: /sma-onboard, /sma-new-project, or /sma-plan-phase)
</process>
