...
<execution_context>
@~/.claude/sma-core/workflows/execute-phase.md
...
Context files are resolved inside the workflow via `sma-tools query init.execute-phase` and per-subagent `<files_to_read>` blocks.
</context>
