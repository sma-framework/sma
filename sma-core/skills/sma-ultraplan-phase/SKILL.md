...
Review and comment on the plan in your browser, then import it back via /sma-import --from.

⚠ BETA: ultraplan is in research preview. Use /sma-plan-phase for stable local planning.
Requirements: Claude Code v2.1.91+, claude.ai account, GitHub repository.
</objective>

<execution_context>
@~/.claude/sma-core/workflows/ultraplan-phase.md
