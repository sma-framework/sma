...
| **V5** | **Оркестрация: парк работников 24/7** | ✅ **текущая** (v5.0.0 → v5.2.0, июль–август 2026) |
...
Все три закона построены: проект — измерение задачи, знакомство с пиром это одноразовое приглашение, которое человек переносит с hub-а руками, а hub пробрасывает действие машине-владельцу вместо того, чтобы переигрывать её логику. Пир, открытый напрямую, по-прежнему показывает свою машину — с тихой плашкой, когда hub недоступен, — так что единой точкой отказа hub не является. Две дыры остаются намеренно и названы вслух: **телефон** получит собственный дизайн-заход в V5.2/V5.3 (V5.1 сделана под настольный экран), а контур пока доказан двумя демонами на одной машине — повторить его на двух физических машинах ещё предстоит отдельным смоуком.
