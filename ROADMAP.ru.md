...
| **V5.6** | **Задачник и числа, которые не врут** | ✅ **вышла** (v5.6.0, в репозитории) — в npm не выложена, пока двигатель устаканивается |
...
## V5.6 — Задачник и числа, которые не врут ✅ (v5.6.0)
