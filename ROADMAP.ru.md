...
| **V5** | **Оркестрация: парк работников 24/7** | ✅ **текущая** (v5.0.0 → v5.4.0, июль–август 2026) |
...
| V5.3 | Управление памятью, укреплённый парк | ✅ **вышла** (v5.3.0, 6 августа 2026) — пилоты внешней валидации переносятся дальше |
| V5.4 | Целый рабочий день без терминала | ✅ **вышла** (v5.4.0, 7 августа 2026) — пятидневный доказательный прогон это эксплуатация после выпуска |
...
где дневная работа действительно происходит. Таблица маршрутов выросла с тридцати дверей до
**пятидесяти трёх**, объявлена один раз и заморожена, и живёт каждая: тест формы, стерегущий
таблицу, снова безусловный — заглушек «скоро будет» в ней не осталось.
